...
//Ex7
//-----------------------------------------------------------------------------------------
            //run_Method method = new run_Method(Timer_1.ReturnString);
            //System.Timers.Timer atimer = new System.Timers.Timer(1000);

            //atimer.Elapsed += (s, e) =>
            //    {
            //        Timer_1.ReturnString();
            //    };
            //atimer.Start();
//Ex9 LinQ
//------------------------------------------------------------------------------------
            ...
            //var student3=student_List.OrderBy(student=>student.FirstName +" "+student.LastName).Where(student=>student.Lesser_Mark(student.Marks)==2).Select(student=>student);
